...
handleSubmit = (id) => {
  Alert.alert(
      ...
      [
        ...
        {text: 'YES', onPress: () => axios.delete('http://192.168.0.3:3000/songs/'+id)
  ...
  render() {
    ...
    return (
      <ScrollView style={styles.container}
        ...
        <Text style={styles.lightText}>{item.price}</Text></TouchableOpacity>}
 />
    
        <Button
          title="Edit"
          onPress={() => this.props.navigation.navigate('Edit',{id:item._id})}
        />
